...
const insertUserModel = async (username, email, password, role, registrationCode) => {
    ...
    await pool.query(
        `INSERT INTO users (username, email, password, role, registrationCode) VALUES (?, ?, ?, ?, ?)`,
        [username, email, hashedPass, role, registrationCode],
    );
};
